...
export default class Editor extends Component {
    ...
    open(page, cb) {
        ...
        axios
            ...
            .then(() => this.iframe.load("../efeferrds_fgfg.html"))
    ...
    async save() {
        ...
        await axios
            ...
            .then(() => this.showNotifications('Successfully', 'success'))
    ...
    loadBackupsList() {
        axios
            ...
            .then(res => this.setState({
                backupList: res.data.filter(backup => {
    ...
    restoreBackup(e, backup) {
        ...
        UIkit.modal.confirm("Do you want to restore the page from this backup? All unsaved data will be lost.", { labels: { ok: 'Backup', cancel: 'Cancel' } })
            .then(() => {
                this.isLoading();
                return axios
    ...
    render() {
        const {loading, pageList, backupList, auth, loginError, loginLengthError} = this.state;
        const modal = true;
        let spinner;
        ...
        return (
            <>
                ...
                text={{
                    title:"Exit",
                    descr: "Do you want to exit?",
                    btn: "Log Out"
                }} />

                <ChooseModal modal={modal} target={'modal-open'} data={pageList} redirect={this.init} />
                <ChooseModal modal={modal} target={'modal-backup'} data={backupList} redirect={this.restoreBackup} />
